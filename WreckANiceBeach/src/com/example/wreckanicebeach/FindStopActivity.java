...
public class FindStopActivity extends FragmentActivity implements
	...
	public void onConnected(Bundle arg0) {
		...
		if (loadedFlag == false && mCurrentLocation != null) {
			...
			String urlString = (URL_BASE + API_KEY + "&lat=" + latitude
					+ "&lon=" + longitude);
			loadPage(urlString);
			loadedFlag = true;
		}
	...
	private String loadXmlFromNetwork(String urlString)
		...
		stopArray = stops.toArray(stopArray);
		Stop firstStop = stopArray[0];
		String stopString = "The closest stop is " + firstStop.name;
